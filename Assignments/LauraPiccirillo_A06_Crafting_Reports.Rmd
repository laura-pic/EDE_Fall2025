...
```{r plot2018, echo=FALSE, warning=FALSE, fig.align='left',fig.height=3, fig.cap= "2018 monthly Ozone levels"}
epa_data_2018 <- epa_data %>% filter(Year == 2018)
ggplot(epa_data_2018, aes(x=factor(Month, levels=1:12, 
                                            labels=month.abb), 
                                   y = Ozone)) + geom_boxplot() + 
  xlab("Month") + ylab("Concentration ", mu, "g/")
                       #, m^{3}, ")") + ggtitle("")
#"Mean is ", mu,", ", R^{2},"=0.6"
```


```{r plot2019, echo=FALSE, warning=FALSE, fig.align='left', fig.height=3, fig.cap="2019 monthly Ozone levels"}
epa_data_2019 <- epa_data %>% filter(Year == 2019)
ggplot(epa_data_2019, aes(x=factor(Month, levels=1:12, 
                                            labels=month.abb), 
                                   y = Ozone)) + geom_boxplot() + xlab("Month")
