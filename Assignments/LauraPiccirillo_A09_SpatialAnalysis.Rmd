...
> ANSWER: 4269. This is a geographic CRS as it uses latitude/longitude measurements (angular units)
...
#mapview(nebraska_counties, col.regions = "gray") + 
  #mapview(all_gage, zcol = "gage_ht")
...
#25 Plot
ggplot() + geom_sf(data = nebraska_counties_2) + 
  geom_sf(data = washington, fill = "red") + 
  geom_sf(data=washington_20km_gages, color = "black") + 
  geom_sf(data=washington_gages, color = "green")
