...
```{r scatterplot.2, warning=FALSE, fig.width=8}
#14. ggplot
...
>Answer: Paul Lake and Ward Lake have the same mean temperature statistically as Peter Lake. No lake has a mean temperature that is statistically signifcant from all other lakes.
