...
#Number of samples using each different source 
ggplot(data = pm25, aes(Source)) + geom_bar()

#Distribution of daily mean concentration values
ggplot(data = pm25, aes(Daily.Mean.PM2.5.Concentration)) + 
  geom_histogram()


#Distribution of daily mean concentration, by source
ggplot(data = pm25, aes(Source, Daily.Mean.PM2.5.Concentration)) + 
  geom_boxplot()
