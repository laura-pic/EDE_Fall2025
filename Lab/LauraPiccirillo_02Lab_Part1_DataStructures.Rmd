...
#Combined vectors 1 and 4
c(vector1, vector4)

#Vector 1 multiplied by vector 4
vector1 * vector4

#Vector 1 values multiplied by 10
vector1 * 10

#Changed characters in vector 2 to uppercase
toupper(vector2) 

#Reversed logical arguments in vector 3
!vector3
...
```{r Creating Matrices}
# Matrices ----
matrix1 <- matrix(1:20, nrow = 5, ncol = 4) # creating matrix 1 with numbers 1-20 in 5 rows and 4 columns
matrix1
#matrix1 has 5 rows and 4 columns

matrix2 <- matrix(1:20, nrow = 5, ncol = 4, byrow = TRUE) # creating matrix 1 with numbers 1-20 in 5 rows and 4 columns and the numbers are ordered/populated by row, so across
matrix2
...
matrix1[4, 1]# gives the fourth row, 1st column value

matrix1[4,  ] # gives the whole fourth row because column isn't specified

matrix1[ , 3] # gives the whole 3rd column because row isn't specified

matrix1[c(12, 14)] # returns the 12th and 14th item in the matrix

matrix1[c(12:14)] # returns the 12th - 14th item in the matrix

matrix1[2:4, 1:3] # slicing through rows 2-4 and columns 1-3
...
matrix4 # returns newly made matrix 4
