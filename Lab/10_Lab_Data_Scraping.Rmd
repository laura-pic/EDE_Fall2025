...
#Set the URL
theURL <- 
  'https://waterdata.usgs.gov/nwis/uv?search_site_no=02085070&period=7&format=rdb'
...
#Set the URL
theURL <- 
  'https://waterdata.usgs.gov/nwis/uv?search_site_no=02085070&search_site_no_match_type=exact&group_key=NONE&sitefile_output_format=html_table&column_name=agency_cd&column_name=site_no&column_name=station_nm&range_selection=days&period=24&format=rdb&date_format=YYYY-MM-DD&rdb_compression=value&list_of_search_criteria=search_site_no'
...
the_states <- the_website %>%
  html_nodes(tr :nth-child(1)) %>% html_text()
the_price <- 
the_capacity <- 
net_generation <- 
total_retail <- 
